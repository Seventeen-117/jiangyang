...
import static com.jiangYang.cloud.framework.common.util.date.LocalDateTimeUtils.*;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("jiangYang-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("jiangYang-test");
