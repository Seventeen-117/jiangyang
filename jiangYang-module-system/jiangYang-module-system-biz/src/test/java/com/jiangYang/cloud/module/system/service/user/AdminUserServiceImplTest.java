...
import com.jiangYang.cloud.framework.test.core.ut.BaseDbUnitTest;
...
import static com.jiangYang.cloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.jiangYang.cloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.jiangYang.cloud.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.jiangYang.cloud.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.jiangYang.cloud.framework.test.core.util.AssertUtils.assertServiceException;
import static com.jiangYang.cloud.framework.test.core.util.RandomUtils.*;
import static com.jiangYang.cloud.module.system.enums.ErrorCodeConstants.*;
import static com.jiangYang.cloud.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("JiangYangyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("JiangYangyuanma");
        ...
        assertEquals("JiangYangyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("JiangYangyuanma"))).thenReturn("java");
